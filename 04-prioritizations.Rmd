...
# plot solution
plot(
  st_as_sf(s2[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
```
...
# plot solution
plot(
  st_as_sf(s3[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
```
...
# plot solution
plot(
  st_as_sf(s4[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
```
...
# plot solution
plot(
  st_as_sf(s5[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
```
...
# plot solution
plot(
  st_as_sf(s6[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
...
wts <- 1 / global(veg_data, "sum", na.rm = TRUE) %>%
  pull(sum)
...
# plot solution
plot(
  st_as_sf(s7[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
# calculate feature representation
...
p8 <- problem(pu_data, veg_data, cost_column = "cost") %>%
      ...
      add_highs_solver(verbose = TRUE, gap = 10)
```
...
# plot first solution
plot(
  st_as_sf(s8[, "solution_1"]), main = "Prioritization",
  pal = c("grey90", "darkgreen")
)
```
...
```{r, out.width = "65%"}
# plot all solutions
plot(st_as_sf(s8 %>% dplyr::select(starts_with("solution_"))),
     pal = c("grey90", "darkgreen"))
```
